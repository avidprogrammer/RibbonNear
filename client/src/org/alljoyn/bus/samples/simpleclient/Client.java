...
import accl.MoveNotify; 
import accl.accelerometer;
...
public class Client extends Activity implements MoveNotify{
    ...
    class BusHandler extends Handler {    	
         ...
         */
        private static final String SERVICE_NAME = "org.alljoyn.bus.ribbonnear.simple";
	...
	public void moveNotify(float[] new_cord) {
		if (!mBusHandler.mIsConnected)
			return; 
		String txt = "X : " + String.valueOf(new_cord[0]) + " Y : " + String.valueOf(new_cord[1]); 
		Message msg = mBusHandler.obtainMessage(BusHandler.PING, txt);
		Log.d("DBG", "MOVING " + txt); 
		mBusHandler.sendMessage(msg);
	}
}
